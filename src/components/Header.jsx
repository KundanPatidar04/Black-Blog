  ...
  return (
    ...
    <header className='container mx-auto m-2'>
        <div className='d-flex justify-content-between col-12'>
            <div className='my-auto'><Link className='btn btn-danger px-4 rounded-5'>Subscribe</Link></div>
        ...
        <div className='border-top border-bottom border-secondary m-2'>
            <ul className='d-flex list-unstyled col-6 justify-content-between mx-auto my-2 py-  2 px-auto '>
